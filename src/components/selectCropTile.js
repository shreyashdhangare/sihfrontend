...
export default class selectCropTile extends Component {
    render() {
        const newTo = { 
            pathname: "/account/addcrop/"+this.props.farmid+"/"+this.props.cropid
          };
        return (
            <div>
        ...
        <div className="item-box-blog-date bg-blue-ui white"> <span className="mon">{this.props.cropid}</span> 
                    ...
                    <div className="item-box-blog-body">
                        <div className="item-box-blog-heading">
                                ...
                                <div className="mt"> <Link to={newTo} className="btn bg-blue-ui white read">Add Crop to Farm</Link> </div>
                            </div>
                    </div>
                </div>
                </div>
